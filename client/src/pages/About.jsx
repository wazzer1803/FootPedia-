      ...
      <div className='max-w-2xl mx-auto p-3 text-center'>
        <div>
          ...
          <div className='text-md text-gray-500 flex flex-col gap-6'>
            <p>
              Welcome to FootPedia! This blog was created by Sahil Chauksey
              as a personal project to share his thoughts and football knowledge with the
              world. Sahil is a passionate football enthusiast who writes regularly about his favourite football club,Liverool FC.
            </p>

            <p>
              On this website, you'll find weekly articles and updates of the current happenings in the football world
             . Sahil is always on the lookout for new and exciting football deals and rumours
