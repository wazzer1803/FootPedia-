    ...
    <Navbar className='border-b-2 bg-black'>
      ...
      <div className='flex gap-2 md:order-2'>
        ...
        {currentUser ? (
          ...
          >
            <Dropdown.Header className='shadow-lg rounded-lg'>
            ...
            <Link to={'/dashboard?tab=profile'}>
              <Dropdown.Item className='shadow-lg rounded-lg'>Profile</Dropdown.Item>
            </Link>
            <Dropdown.Divider />
      ...
      <Navbar.Collapse>
        ...
        <Navbar.Link active={path === '/projects'} as={'div'}>
          <Link to='/projects'>Articles Gallore</Link>
        </Navbar.Link>
      </Navbar.Collapse>
    </Navbar>
  );
